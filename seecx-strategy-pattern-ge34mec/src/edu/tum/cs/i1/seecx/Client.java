...
public class Client {
	...
	// Create a SortStrategy interface according to the UML class diagram
	// Make the sorting algorithms implement this interface.
	
	// Create and implement a Context class according to the UML class diagram
	// Create and implement a Policy class as described in the problem statement
